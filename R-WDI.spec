...
Version  : 2.5.1
Release  : 5
URL      : https://cran.r-project.org/src/contrib/WDI_2.5.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/WDI_2.5.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544227006
